...
export const CHAPTERS = [
  ...
  { id: 'anatomy',      num: '03B', toc: true, title: 'Inside the layer: the component catalog',       load: () => import('./chapters/03b-anatomy.js') },
  { id: 'attention',    num: '04', toc: true,  title: 'Attention, step by step',                       load: () => import('./chapters/04-attention.js') },
  { id: 'attention-scale', num: '04B', toc: true, title: 'Attention at scale: long context and the memory wall', load: () => import('./chapters/04b-attention-scale.js') },
  ...
  { id: 'multimodal',   num: '11', toc: true,  title: 'Beyond text: how images, audio, and video get in', load: () => import('./chapters/12-multimodal.js') },
