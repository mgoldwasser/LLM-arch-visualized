...
export function render() {
  return el('section', { class: 'chapter', id: 'hero', style: { marginTop: 0 } },
    el('div', { class: 'hero measure', style: { maxWidth: 'var(--col-wide)' } },
      ...
      el('div', { class: 'meta' }, '~75 min · 10 chapters · scroll-driven figures · interactive widgets'),
      ...
      el('p', { class: 'lede' },
        ...
        'Written for people who build deep-learning models but haven’t trained a transformer. Everything here moves: scroll slowly, and watch the machine assemble itself.'),
